...
═══ FORMATO C — PERSONA (DNI, pasaporte, partidas, licencias) ═══
{
  ...
  "personas": [{
    ...
    "provincia": "REGLA 1: si aparece 'X - X' con el mismo nombre repetido (SAN JUAN - SAN JUAN, CÓRDOBA - CÓRDOBA, etc.), el segundo es la provincia. REGLA 2: si el departamento es uno de los siguientes → provincia es Mendoza: Godoy Cruz, Maipú, Luján de Cuyo, Las Heras, Guaymallén, San Martín, San Rafael, General Alvear, Rivadavia, Tunuyán, Tupungato, San Carlos, La Paz, Santa Rosa, Malargüe, Lavalle, Junín. REGLA 3: si no podés inferir la provincia, dejá vacío.",
