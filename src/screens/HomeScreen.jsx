...
const TIPO_LABEL = {
  // slugs legacy (camelCase)
  certFirma:              "Cert. firma",
  cert_firma:             "Cert. firma",
  certFirmaF08:           "Cert. F08",
  cert_firma_f08:         "Cert. F08",
  poderEspecial:          "Poder especial",
  poder_especial:         "Poder especial",
  poderGeneral:           "Poder general",
  poder_general:          "Poder general",
  poder_administracion:   "Poder admin.",
  poder_irrevocable:      "Poder irrevoc.",
  revocacion_poder:       "Revoc. poder",
  actaConst:              "Acta const.",
  acta_constatacion:      "Acta const.",
  acta_manifestacion:     "Acta manif.",
  acta_notificacion:      "Acta notif.",
  acta_asamblea:          "Acta asamblea",
  acta_directorio:        "Acta direc.",
  acta_entrega:           "Acta entrega",
  autViaje:               "Aut. viaje",
  autorizacion_viaje:     "Aut. viaje",
  autorizacion_vehiculo:  "Aut. vehículo",
  compraventa:            "Compraventa",
  compraventa_urbana:     "CV urbana",
  compraventa_rural:      "CV rural",
  compraventa_ph:         "CV PH",
  compraventa_lote:       "CV lote",
  boleto_compraventa:     "Boleto CV",
  donacion_inmueble:      "Donación",
  donacion_hijo:          "Donación hijo",
  donacion_reserva_uso:   "Donación uso",
  locacion_inmueble:      "Locación",
  locacion_comercial:     "Loc. comercial",
  mutuo_simple:           "Mutuo",
  mutuo_hipotecario:      "Mutuo hipot.",
  cesion_herencia:        "Ces. herencia",
  cesion_cuotas:          "Ces. cuotas",
  renuncia_herencia:      "Renuncia her.",
  particion_herencia:     "Partición",
  declaratoria_herederos: "Declaratoria",
  aprobacion_testamento:  "Testamento",
  hipoteca_constitucion:  "Hipoteca",
  hipoteca_cancelacion:   "Cancelac. hip.",
  usufructo_constitucion: "Usufructo",
  servidumbre:            "Servidumbre",
  superficie:             "Superficie",
  convenio_division:      "Conv. división",
  prenda_con_registro:    "Prenda",
  reconocimiento_deuda:   "Rec. deuda",
  copia_simple:           "Copia simple",
  cert_copia:             "Cert. copia",
  primer_testimonio:      "1° testimonio",
  testimonio_posterior:   "Testimonio",
  fe_vida:                "Fe de vida",
  contrato_srl:           "Contrato SRL",
  estatuto_sa:            "Estatuto SA",
  estatuto_sas:           "Estatuto SAS",
  aumento_capital:        "Aum. capital",
};
...
function TipoPill({ templateKey }) {
  ...
  return (
    <span style={{ fontSize:11, padding:"2px 8px", borderRadius:5, fontWeight:500,
                   ...
                   maxWidth:110, overflow:"hidden", textOverflow:"ellipsis", display:"inline-block" }}>
      {label}
    </span>
  );
}
