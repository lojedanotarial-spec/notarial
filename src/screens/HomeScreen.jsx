...
function FilaReciente({ doc, last }) {
        ...
        <div style={{ width:"100%", maxWidth:900, display:"flex", flexDirection:"column", gap:S.xl }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:S.md }}>
            ...
            <div
              ...
              style={{ padding:"18px 20px", background:C.cerulean, borderRadius:R.lg,
                       cursor:"pointer", display:"flex", alignItems:"center", gap:S.md, opacity:"0.9",
            ...
            >
              ...
              <div>
                <div style={{ ...T.l1, color:"#fff", marginBottom:3 }}>Carga masiva</div>
                <div style={{ ...T.l2, color:"rgba(255,255,255,.75)", lineHeight:1.5 }}>
                  Generar multiples documentos homogeneos.
                </div>
              </div>
            </div>
            ...
            <div style={{ background:"#fff", borderRadius:R.lg, border:"1px solid rgba(26,35,50,.08)", overflow:"hidden" }}>
              {filtrados.length > 0 ? (
                filtrados.map((doc, idx) => (
                  <FilaReciente key={doc.id} doc={doc} last={idx === filtrados.length - 1} />
                ))
              ) : (
