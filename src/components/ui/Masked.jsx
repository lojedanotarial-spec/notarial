...
// ── FECHA dd/mm/aaaa ──────────────────────────────────────────────────────
export function InputFecha({ value, onChange, onBlur, style, placeholder = "dd/mm/aaaa" }) {
  ...
  return <input value={value} onChange={handleChange} onBlur={onBlur} placeholder={placeholder} maxLength={10} style={style}/>;
}

// ── DINERO $1.234.567,89 ──────────────────────────────────────────────────
export function InputDinero({ value, onChange, onBlur, style, placeholder = "$0,00" }) {
...
// ── DECIMAL con coma ──────────────────────────────────────────────────────
export function InputDecimal({ value, onChange, onBlur, style, placeholder = "0,00" }) {
  const [raw, setRaw] = useState(value || "");
