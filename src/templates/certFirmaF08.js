/**
 * Template: Certificacion de Firma - F08
 * Genera el HTML del documento a partir de los datos del panel.
 */
...
export function buildCertFirmaF08({ partes, escribano, fecha, protocolo, instrumento, instrTexto, fechaLetras, MESES_LABEL, gen }) {
