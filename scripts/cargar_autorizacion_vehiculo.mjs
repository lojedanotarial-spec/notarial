...
const variables_json = [
  ...
  },
  {
    ...
    label: "Modelo",
    type: "texto",
    placeholder: "Ej: CROSSFOX 1.6",
    required: true,
  },
  {
    name: "VEHICULO_TIPO_DESC",
    label: "Tipo / carrocería",
    type: "texto",
    placeholder: "Ej: SEDAN 5 PTAS / MOTOCICLETA",
    required: true,
  },
  {
  ...
  },
  {
    ...
    label: "N° de chasis",
    type: "texto",
    placeholder: "Ej: 98WKB052964173498",
    required: true,
  },
  {
    name: "VEHICULO_MOTOR",
...
if (existente) {
  ...
  const { error } = await sb.from("templates").insert({
    slug:           "autorizacion_vehiculo",
    nombre:         "Autorización para conducir / exportar vehículo",
    tipo:           "extraprotocolar",
    familia:        "autorizaciones",
    descripcion:    "Autorización para conducir, exportar e importar vehículo o motovehículo. Instrumento extraprotocolar.",
    frecuencia:     5,
    contenido,
    variables_json,
    registro_id:    null,
